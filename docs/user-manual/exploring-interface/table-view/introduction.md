...
- **Manage metadata**: View or edit metadata associated with the selected columns or cells. _(Learn more about [Matching Revision](../../enrichment-operations/reconciliation/matching-revision#entity-matching-revision))_
- **Refine matching**: Part of the enrichment process. _(Learn more about [Refinement](../../enrichment-operations/reconciliation/matching-revision#refinement))_
...
- **Modification, Reconciliation and Extension**: Part of the enrichment process. _(Learn more about [Enrichment Operations: Modification](../../enrichment-operations/modification), [Reconciliation](../../enrichment-operations/reconciliation/introduction) and [Extension](../../enrichment-operations/extension))_
- **Gen AI**: Leverage Large Language Models to perform advanced operations on your selection, including automated
  Modification, Reconciliation and Extension tasks tailored to the table's context. _(Learn more about [Generative AI](../../enrichment-operations/generative-ai))_
