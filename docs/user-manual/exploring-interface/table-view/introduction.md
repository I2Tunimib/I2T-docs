...
- **Manage metadata**: View or edit metadata associated with the selected columns or cells. _(Learn more about [Matching Revision](../../enrichment-operations/reconciliation/matching-revision.md))_
- **Refine matching**: Part of the enrichment process. _(Learn more about [Refinement](../../enrichment-operations/reconciliation/matching-revision.md))_
...
- **Modification, Reconciliation and Extension**: Part of the enrichment process. _(Learn more about [Enrichment Operations](../../enrichment-operations/modification))_
